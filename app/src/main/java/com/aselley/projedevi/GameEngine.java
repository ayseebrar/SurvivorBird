...
gameState = 0;
     ...
     public void updateAndDrawBackgroundImage(Canvas canvas){
      ...
      if (backgroundImage.getX()< -(AppConstants.getBitmapBank().getBackgroundWidth() - AppConstants.SCREEN_WİDTH)){
     ...
     public void updateAndDrawBird(Canvas canvas){
        if(gameState == 1) {
            if (bird.getY() < (AppConstants.SCREEN_HEİGHT - AppConstants.getBitmapBank().getBirdHeight()) || bird.getVelocity() < 0) {
